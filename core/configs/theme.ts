...
import { AppBar, ContentWidth, Footer, HorizontalMenuToggle, Mode, Skin, VerticalNavToggle } from '../../types/layout'
...
const themeConfig: ThemeConfig = {
  // ** Layout Configs
  templateName: env.NEXT_PUBLIC_APP_NAME /* App Name */,
  templateSubName: '' /* App Name */,
  themeColor: '#fc9459',
  mode: 'dark' as Mode /* light | dark */,
